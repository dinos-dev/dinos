    ...
    return (
        <View style={styles.container}>
            ...
            >
                {selectedLocation && (
                    <Callout>
                        <Marker draggable coordinate={selectedLocation} title="선택위치" description="지도를 클릭해 선택한 위치" onPress={() => Alert.alert('마커 클릭')}>
                ...
                <Marker draggable coordinate={{ latitude: 37.561389, longitude: 126.977778 }} title="마커" description="리스트 1에 저장된 위치" />
            </MapView>
            ...
            <View style={styles.buttonBox}>
                ...
                <Pressable style={styles.mylocation} onPress={() => MoveToCurrentLocation(userLocation.latitude, userLocation.longitude)}>
                    <Text style={styles.icon}>🌐</Text>
                </Pressable>
            </View>
